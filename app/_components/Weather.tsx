...
export default function Weather({ }: Props) {
	...
	const getWeather = async () => {
		try {
			...
			const weather = await fetch('https://api.open-meteo.com/v1/forecast?latitude=51.439372&longitude=-2.586256&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,rain,showers,snowfall,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m&daily=sunrise,sunset&wind_speed_unit=mph&timeformat=unixtime');
			...
			setWeatherList([
				{
					...
					iconSrc: getIconSrc(currentData.cloud_cover, currentData.rain, currentData.is_day),
				},
			]);
		}
	}, [weather]);
					...
					<div>
						<div className="flex items-center justify-between gap-5">
							<div className="grow">
								...
								<div>
									It Feels like{" "}
									<div className="text-xl font-bold">19.9</div>
								</div>
							</div>
							<div>
								<Image
